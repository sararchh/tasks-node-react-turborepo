...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseClasses = 'font-medium h-[2.5rem] !p-4 cursor-pointer !rounded-sm outline-none focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors duration-200 disabled:cursor-not-allowed flex items-center justify-center gap-2';
